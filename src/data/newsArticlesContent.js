...
export const newsArticlesRaw = [
  ...
  {
    id: 15,
    slug: "pda-wusc-eumc-80th-international-seminar-2026-closing-ceremony",
    type: "news",
    imageKey: "wuscseminar2026",
    dateIso: "2026-08-12",
    en: {
      date: "August 12, 2026",
      title: "PDA Participates in WUSC-EUMC's 80th International Seminar 2026 Closing Ceremony",
      description:
        "Participatory Development Associates Ltd. (PDA) joined the World University Service of Canada (WUSC-EUMC) and partners in marking #InternationalYouthDay at the closing ceremony of the WUSC-EUMC 80th International Seminar 2026 in Ghana, bringing together 24 young leaders from Ghana and Canada for a journey of cultural exchange and youth-led solutions.",
      category: "Youth Development",
      location: "Accra, Ghana",
      fullContent: [
        "Participatory Development Associates Ltd. (PDA) joined the World University Service of Canada (WUSC-EUMC) and partners in marking #InternationalYouthDay at the closing ceremony of the WUSC-EUMC 80th International Seminar 2026 in Ghana, held at the Palms by Eagles Hotel, formerly known as the Holiday Inn. PDA's participation reflected its long-standing relationship with WUSC and its shared commitment to initiatives that promote youth participation, inclusive development, learning, and meaningful opportunities for young people. The event brought together 24 young leaders, comprising 12 participants from Ghana and 12 from Canada, for a journey focused on cultural exchange, collaboration, learning, and youth-led solutions to challenges affecting young people.",
        "The ceremony commenced with a networking and registration session, followed by photographs and a highlight video showcasing the participants' experiences throughout the Seminar. The video captured key moments of learning, cultural exchange, collaboration, friendship, and shared experiences among the Ghanaian and Canadian participants.",
        "The programme officially opened with a welcome address from Appiah Wiafe Adofo, WUSC Country Director, who reflected on the importance of youth collaboration and international partnerships in promoting inclusive development. This was followed by a keynote address from H.E. Myriam Montrat, Canadian High Commissioner, who encouraged young people to take an active role in shaping the future, reminding participants that \"The future is built, not inherited.\"",
        "Further reflections were shared by Sakina Musa, International Seminar Coordinator, who highlighted the participants' journey and the importance of continued learning, cultural exchange, and meaningful youth engagement.",
        "A major highlight of the ceremony was the presentation of findings, research, and data developed by the young leaders during the Seminar. Their work focused on the future of youth employment and entrepreneurship, with particular attention to demand and supply, access, and inclusion.",
        "The discussions highlighted challenges facing young people in Ghana's growing digital economy. While digital opportunities continue to expand, many young people, particularly those in rural and low-income communities, face barriers such as high data costs, limited access to suitable digital devices and skills, and difficulties accessing affordable finance. These challenges can limit young people's ability to search for jobs, develop digital skills, reach customers, participate in online markets, and grow businesses.",
        "The participants' policy briefs therefore explored practical pathways for creating a more inclusive youth employment ecosystem. Their findings emphasised the need to address interconnected barriers to digital access, skills development, finance, employment, and entrepreneurship so that more young people can benefit from emerging opportunities.",
        "The ceremony also provided opportunities for cultural exchange and celebration. A cultural presentation highlighted the diversity of the Ghanaian and Canadian participants, while certificates were presented to all 24 young leaders in recognition of their successful completion of the Seminar and their commitment throughout the programme.",
        "Representatives from the Ghana Chamber of Young Entrepreneurs (GCYE) and Social Enterprise Ghana (SE Ghana) also engaged participants on youth entrepreneurship, enterprise development, and opportunities within Ghana's entrepreneurial ecosystem. Their contributions reinforced the importance of strengthening support systems that enable young people to create and sustain meaningful livelihoods.",
        "The programme concluded with a shared lunch, photography, networking, and informal exchanges among participants and partners. The closing ceremony celebrated not only the completion of the Seminar but also the relationships, knowledge, and ideas developed through the Ghana-Canada exchange.",
        "For PDA, the event reaffirmed the value of partnerships that create space for young people to exchange ideas, build confidence, and contribute to solutions that matter to their communities. PDA remains committed to the ideals advanced by WUSC and IGNI+E, including inclusion, youth leadership, cultural exchange, and collaborative action. The lessons and perspectives shared throughout the event also reinforce PDA's wider work to support inclusive development and create meaningful opportunities for young people in Ghana.",
      ],
      additionalInfo: [
        "Event: WUSC-EUMC 80th International Seminar 2026 Closing Ceremony",
        "Venue: Palms by Eagles Hotel, Ghana",
        "Participants: 24 young leaders (12 from Ghana, 12 from Canada)",
        "Theme: #InternationalYouthDay — youth employment and entrepreneurship",
      ],
    },
  },
  // {
